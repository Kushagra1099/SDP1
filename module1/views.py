...
def hello1(request):
    return HttpResponse("<centre>Welcome to the home page</centre>")
...
def pie_chart(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            plt.savefig('static/images/pie_chart.png')  # Save the chart imagepytr
...
def weatherlogic(request):
    if request.method == 'POST':
        ...
        API_KEY = '5ac16f861f019c0dc82e79aa009909fc'
